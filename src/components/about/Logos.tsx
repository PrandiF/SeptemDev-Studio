...
import bsasCars from "../../assets/bsasCars.webp";
...
function Logos() {
  return (
    <div className="flex items-center relative w-full h-[110px] border-y border-azulado z-10 px-4 py-3 gap-8 shadow-inner">
      ...
      <img src={motorville} className=" w-[83px] h-[83px] rounded-full flex" />
      <img src={bsasCars} className=" w-[83px] h-[83px] rounded-full flex" />
      <img src={septemDev} className=" w-[83px] h-[83px] rounded-full flex" />

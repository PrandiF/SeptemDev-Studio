...
CardProps) {
  ...
  return (
    ...
    >
      <img
        src={imageUrl}
        className="w-28 h-28 mt-8 rounded-full object-cover border-4 border-slate-50 z-10 group-hover:scale-125 group-hover:-translate-y-6 transition-all duration-500"
      />
      ...
      <a
        className="w-32 h-8 bg-footer-dark hover:scale-[1.02] text-white font-semibold transform duration-300 rounded-3xl text-sm shadow-xl flex items-center justify-center cursor-pointer"
        href={portfolio}
        target="e_blank"
      >
        Portfolio

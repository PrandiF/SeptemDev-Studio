...
CardProps) {
  ...
  return (
    <div
      className="group before:hover:scale-95 before:hover:h-80 before:hover:w-80 before:hover:rounded-b-2xl before:transition-all before:duration-500 before:content-[''] before:w-80 before:h-24 before:rounded-t-2xl before:bg-gradient-to-bl from-white via-logo to-blue-100 before:absolute before:top-0 xl:w-80 w-72 h-80 relative bg-slate-50 flex flex-col items-center justify-between py-4 gap-2 text-center rounded-2xl overflow-hidden shadow-2xl"
      data-aos={data_aos}
